...
5. What are the source and destination of your tutorial pull request?
...
4. A fork is hosted on GitHub; a clone is local. Push to `origin`, your personal fork. Fetch tutorial updates from `upstream`.
...
| How do I get merged tutorial changes? | on clean `main`, `git pull --ff-only upstream main` |
